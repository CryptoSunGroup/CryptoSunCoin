...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x3456;//addresses start with "cs"
...
const uint64_t MINIMUM_FEE                                   = 150000;
...
const char     CRYPTONOTE_NAME[]                             = "CryptoSunCoin";
